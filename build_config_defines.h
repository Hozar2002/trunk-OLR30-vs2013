...
//#define OBJECTS_RADIOACTIVE // вылет при ункоментировании
// ==================================== Правки от K.D. =======================================
...
// ==================================== Правки от Real Wolf ======================================= 
//#define INV_RUCK_UNLIMITED_FIX		// (ГЛЮЧАТ ПАТРОНЫЙ ПРИ ЮЗЕ ОРУЖИЯ В СЛОТ!!!) Real Wolf: позволяет безболезненно использовать атрибут unlimited в теге dragdrop_bag для создания лимитного инвентаря (ГЛЮЧАТ ПАТРОНЫЙ ПРИ ЮЗЕ ОРУЖИЯ В СЛОТ!!!)
...
// ==================================== Правки от denzor ======================================= 
#define DEAD_BODY_COLLISION				// Коллизия мертвых тел
// #define DRAW_ACTOR_VISUAL_IN_CAR		// Показывать модель актора в транспорте, при виде от первого лица
#define CIRCLE_CROSSHAIR_IN_ALL_WEAPON	// Круглый курсор у всего оружия
#define OFF_DRAW_NPC_INFO_IN_HUD		// Отключить показ информации о видимом НПЦ на худе
#define HIDE_WEAPON_IN_LADDER			// Убирать оружие на лестнице
#define OLR_SLOTS						// Отставить только слоты, необходимые моду OLR (для правки INV_NEW_SLOTS_SYSTEM)
#define OFF_CAM_3_IN_CAR				// Отключить вид от третьего лица в машине


//#define DEBUG_FLYER				// debug_flyer (консольные комманды) (когда закоменчен тут - работает)