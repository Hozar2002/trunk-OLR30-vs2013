...
public:
	...
	//bool						IsActorShoot		() const {return on_weapon_shot_start;}
	//bool						IsActorLanded	() const {return m_bLanded;}
	//virtual	float				IsLanded					() const;
...
private:
	...
	xr_map<EGameActions, bool> m_blocked_actions; // ������ � ���������������� ����������. Real Wolf. 14.10.2014.
public:
