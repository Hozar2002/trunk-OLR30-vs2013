...
void CEatableItem::Load(LPCSTR section)
{
	...
	m_infinity = !!READ_IF_EXISTS	(pSettings,r_bool,section,"no_end",false);
	...
	m_fSleepInfluence			= pSettings->r_float(section, "eat_sleep");
	m_fWaterInfluence			= pSettings->r_float(section, "water_power");
