...
void CHitMemoryManager::load	(IReader &packet)
{
	...
	for (int i=0; i<count; ++i) {
		...
		object.m_level_time			= Device.dwTimeGlobal - object.m_level_time; // фикс
		...
		object.m_last_level_time	= Device.dwTimeGlobal - object.m_last_level_time; // фикс
#endif // USE_LAST_LEVEL_TIME
#ifdef USE_FIRST_LEVEL_TIME
		...
		object.m_first_level_time	= Device.dwTimeGlobal - (*I).m_first_level_time; // фикс
#endif // USE_FIRST_LEVEL_TIME
