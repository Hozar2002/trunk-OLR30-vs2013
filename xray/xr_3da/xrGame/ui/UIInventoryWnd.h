...
public:
	...
	void OutfitStaticSelectWeapon(CWeapon* pWeapon)
	{
		if (UIOutfitBackground)
		{
			UIOutfitBackground->SelectWeapon(pWeapon);
		}
	}
...
protected:
	...
	CUIDragDropListEx*			m_pUIGrenList;
...
#	endif
	...
	Fvector2					UIOutfitBackgroundSize;
	CUI3DActorStatic* 			UIOutfitBackground;
